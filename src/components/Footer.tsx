      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-6">
              ...
              <span className="font-bold text-xl text-white tracking-tight">RoomMate</span>
            </Link>
            <p className="text-slate-400 mb-6 leading-relaxed">
              Making remote living simple, safe, and comfortable. Find verified PGs, hostels, and flatmates with ease.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/pgs" className="text-slate-400 hover:text-blue-400 transition-colors">Find a PG</Link></li>
              <li><Link href="/owners" className="text-slate-400 hover:text-blue-400 transition-colors">List Your Property</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link href="/faq" className="text-slate-400 hover:text-blue-400 transition-colors">Help Center & FAQ</Link></li>
              ...
              <li><Link href="/cancellation" className="text-slate-400 hover:text-blue-400 transition-colors">Cancellation Policy</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-400">123 Layout, Koramangala, Bangalore, Karnataka 560034</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-slate-400">support@roommate.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-slate-500 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} RoomMate Technologies Pvt. Ltd. All rights reserved.
          </p>
          <div className="flex items-center gap-4 text-sm text-slate-500">
            <span className="flex items-center gap-1">Made with <Heart className="w-4 h-4 text-rose-500 fill-rose-500" /> in India</span>
          </div>
        </div>
      </div>
    </footer>
